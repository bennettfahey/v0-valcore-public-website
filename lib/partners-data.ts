...
export const partners: Partner[] = [
  { name: "Optio Systems", url: "https://www.datastorsystems.com/", domain: "datastorsystems.com", description: "Process control for feed, grain, paint & chemical manufacturing" },
  ...
  { name: "Prophet", url: "https://www.prophetsolutions.com/", domain: "prophetsolutions.com", description: "ERP solutions for food & beverage" },
  { name: "Aldata Software", url: "https://www.aldata.com/", domain: "aldata.com", description: "Scale management for bulk materials" },
  { name: "AWS", url: "https://www.awsscales.com/", domain: "awsscales.com", description: "Aggregate weighing systems & software" },
  { name: "SMSTurbo / Fulcrum", url: "https://www.smsturbo.com/", domain: "smsturbo.com", description: "Scale management software for bulk materials" },
  { name: "DISCUS", url: "https://www.discus.com/", domain: "discus.com", description: "Quality engineering and manufacturing automation" },
